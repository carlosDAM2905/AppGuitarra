...
val notasExactas = listOf(
    ...
    NotaVisual("E", 1,4.05f, offsetX = -0.55f), NotaVisual("G",2,4.05f, offsetX = -0.21f),NotaVisual("C",3,4.05f, offsetX = 0.16f), NotaVisual("F",4,4.05f, offsetX = 0.51f), NotaVisual("A",5,4.05f, offsetX = 0.89f), NotaVisual("D",  6,4.05f,  offsetX = 1.26f),
